...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/TodoList.st', // list all sources in dependency order
                    'src/TodoList-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'examples-todo',
                libraries: ['SUnit', 'Web']
            },
            test_runner: {
                ...
                libraries: [
                    ...
                    'TodoList', /* add other code-to-test packages here */
                    'SUnit',
                    'TodoList-Tests' /* add other test packages here */
                ],
